...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ibmcloudant-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ibmcloudant-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ibmcloudant
# for installing globally
pixi global install ibmcloudant
```
...
It is possible to list all of the versions of `ibmcloudant` available on your platform:
...
```
pixi search ibmcloudant --channel conda-forge
```
